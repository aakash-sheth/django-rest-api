...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@defynance.com', 'password': 'testpass', 'name': 'Test'}
        create_user(**payload)
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@defynance.com', 'password': 'pw', 'name': 'Test',}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test3@defynance.com', 'password': 'testpass', 'name': 'Test',}
        create_user(**payload)
    ...
    def test_create_token_missing(self):
        ...
        res = self.client.post(TOKEN_URL, {'email': 'test3@defynance.com', 'password': ' '})
        self.assertNotIn('token', res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
